...
coordinator_tools = [
    AgentTool(
        ...
        parameters={
            "type": "object",
            "properties": {
                "method": {"type": "string", "description": "The method to call on the DevOps agent"},
    ...
    AgentTool(
        ...
        parameters={
            "type": "object",
            "properties": {
                "method": {"type": "string", "description": "The method to call on the SecOps agent"},
                "params": {"type": "object", "description": "Parameters for the method call"}
            },
            "required": ["method"]
        }
    ...
    AgentTool(
        ...
        parameters={
            "type": "object", 
            "properties": {
                "method": {"type": "string", "description": "The method to call on the FinOps agent"},
                "params": {"type": "object", "description": "Parameters for the method call"}
            },
            "required": ["method"]
        }
...
class CoordinatorAgent(AIAgent):
    ...
    async def _execute_tool(self, tool_call) -> Dict[str, Any]:
        ...
        try:
            if function_name == "call_devops_agent":
                return await self._call_agent("devops", kwargs.get("method", "get_system_metrics"), kwargs.get("params", {}))
            elif function_name == "call_secops_agent":
                return await self._call_agent("secops", kwargs.get("method", "get_security_alerts"), kwargs.get("params", {}))
            elif function_name == "call_finops_agent":
                return await self._call_agent("finops", kwargs.get("method", "get_resource_costs"), kwargs.get("params", {}))
    ...
    async def _call_agent(self, agent_type: str, method: str, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": True, "result": result, "agent": agent_type, "method": method}
...
async def start_coordinator_server():
    ...
    async def get_system_overview() -> Dict[str, Any]:
        ...
        try:
            ...
            devops_result = await coordinator._call_agent("devops", "get_system_metrics", {})
            secops_result = await coordinator._call_agent("secops", "get_security_alerts", {}) 
            finops_result = await coordinator._call_agent("finops", "get_resource_costs", {})
    ...
    print(f"Starting Coordinator Agent server on {settings.a2a_host}:{settings.a2a_port}")
